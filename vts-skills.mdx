...
<AccordionGroup>
  ...
  <Accordion title="File .docx sai định dạng / font">
    Đảm bảo có mention `docx` và `tkct-document-builder`, và khởi tạo tài liệu từ
    file Word mẫu (style donor) để kế thừa định dạng chuẩn Viettel.

    TKCT Skills được xây theo một **template chuẩn**. Nếu template của bạn khác
    ...
    dần Agent sẽ bám theo đúng phong cách tài liệu của bạn.

  </Accordion>
  <Accordion title="Sơ đồ vẽ ra chưa chuẩn">
  ...
  <Accordion title="Không kết nối được CSDL">
    Trước tiên, tự kiểm tra máy tính có kết nối được CSDL hay không bằng một
    công cụ khác (MySQL Workbench, DBeaver, `mysql` CLI…) với đúng thông tin
